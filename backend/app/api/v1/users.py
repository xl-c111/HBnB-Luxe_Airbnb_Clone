...
user_model = api.model(
    "User",
    {
        ...
        "password": fields.String(
            required=True, description="Password of the user", min_length=8
        ),
    },
)
...
user_update_model = api.model(
    "UserUpdate",
    {
        ...
        "phone_number": fields.String(
            required=False, description="Phone number for host contact"
        ),
        "home_location": fields.String(
            required=False, description="Home base or location"
        ),
    },
)
